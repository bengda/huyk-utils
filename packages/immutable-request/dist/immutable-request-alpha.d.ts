...
export declare type AugmentedResponseOutput<T> = AugmentedRequired<ResponseOutput<T>, 'data'>;
...
declare interface CRequestApi<D> extends Omit<z.input<typeof RequestApiSchema>, 'response'> {
 ...
 * 仅仅是为了类型定义
 */
export declare function defineRequestApi<D, R>(input: RequestApi<D, R>): RequestApi<D, R>;

declare const ef: unique symbol;

export declare type Fetcher = (request: RequestOutput, api: RequestApiSchemaOutput, requestOpts: RequestOptionsOutput) => Promise<ResponseInput<unknown>>;
 ...
 * @author huyongkang
 */
export declare class ImmutableRequestApiDef<B, M, RT, H, D, R, C, RS> {
 ...
 * ```
 */
export declare class ImmutableRequestObserver<D, R, C, DE, O, F, RP> {
    /**
     * @public
     */
...
export declare type ImmutableRequestObserverEffector<D, R> = AtomEvent<{
    apiDef: RequestApi<D, R>;
    reqId: string;
    status: RequestObserverRequestStatus;
    parse(): any;
...
export declare type ImmutableRequestObserverInterceptor<D, R, C> = AtomEventPool<Record<RequestObserverRequestStatus, ImmutableRequestObserverInterceptorParam<D, R, C>>>;

export declare type ImmutableRequestObserverInterceptorParam<D, R, C> = {
    reqId: string;
...
export declare function request<D, R>(fetcher: Fetcher, apiInput: RequestApi<D, R>, data: D, opts?: RequestOptionsInput): Promise<ResponseOutput<R>>;

declare const Request_2: z.ZodObject<{
    url: z.ZodString;
...
export declare interface RequestApi<D, R> extends Pick<z.output<typeof RequestApiSchema>, 'response'>, CRequestApi<D> {
    response?: z.ZodType<R, any, any>;
}

export declare type RequestApiDefType = ImmutableRequestApiDef<RequestApi<any, any>['baseUrl'], RequestApi<any, any>['method'], RequestApi<any, any>['responseType'], Exclude<RequestApi<any, any>['headers'], undefined> | undefined, any, any, RequestApi<any, any>['custom'], any>;

export declare const RequestApiSchema: z.ZodObject<{
    /**
     * 基路径
     */
...
export declare interface RequestApiSchemaInput extends z.input<typeof RequestApiSchema> {
}

export declare interface RequestApiSchemaOutput extends z.output<typeof RequestApiSchema> {
}

declare interface RequestApiStruct<B, M, RT, H, D, R, C, RS> {
    baseUrl: B;
    url: string;
    method: M;
    responseType: RT;
...
export declare const RequestBody: z.ZodAny;
...
export declare enum RequestExceptionTypeEnum {
    /**
     * 构建的API结构不符合要求
     */
...
export declare const RequestHeaders: z.ZodRecord<z.ZodString, z.ZodString>;

export declare interface RequestInput extends z.input<typeof Request_2> {
}

export declare const RequestMethod: z.ZodEnum<["GET", "DELETE", "HEAD", "OPTIONS", "POST", "PUT", "PATCH", "PURGE", "LINK", "UNLINK", "TRACE", "CONNECT"]>;

export declare type RequestMethodType = z.output<typeof RequestMethod>;

export declare interface RequestObserverKV<D, R, C, DE, O, F, RP> {
...
export declare type RequestObserverRequestStatus = 'prepare' | 'pending' | 'resolved' | 'rejected';

export declare const RequestOptions: z.ZodObject<{
    /**
     * @default false
     */
...
export declare interface RequestOptionsInput extends z.input<typeof RequestOptions> {
}

export declare interface RequestOptionsOutput extends z.output<typeof RequestOptions> {
}

export declare interface RequestOutput extends z.output<typeof Request_2> {
}

declare const Response_2: z.ZodObject<{
    data: z.ZodDefault<z.ZodAny>;
    /**
     * http请求状态码
     */
...
export declare const ResponseCookies: z.ZodArray<z.ZodString, "many">;

export declare const ResponseHeaders: z.ZodRecord<z.ZodString, z.ZodString>;

export declare interface ResponseInput<T> extends z.input<typeof BaseResponse> {
    data?: T;
}

export declare interface ResponseOutput<T> extends z.output<typeof BaseResponse> {
    data?: T;
}

declare const ResponseType_2: z.ZodEnum<["arraybuffer", "blob", "document", "json", "text", "stream"]>;
export { ResponseType_2 as ResponseType }

export declare type ResponseTypeList = z.output<typeof ResponseType_2>;
